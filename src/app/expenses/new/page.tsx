...
export default function AddExpensePage() {
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    ...
    toast({ title: 'Despesa adicionada!', description: `"${values.description}" foi salva.` });
    router.back();
  };
  ...
  return (
    <main className="container mx-auto p-4 md:p-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-3xl">Adicionar Nova Despesa</CardTitle>
          <CardDescription>Preencha os detalhes do novo gasto.</CardDescription>
        </CardHeader>
        <Form {...form}>
